		...
		<h1>新闻管理</h1>
			<?php 
				...
				//$res = mysql_query($sql,$con);
					...
					echo"<td style='width:100px'>"."新闻id"."</td>";
					echo"<td style='width:100px'>"."新闻标题"."</td>";
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					echo "<tr style='width:600px'>";
					echo"<td style='width:100px'>".$row['news_id']."</td>";
					echo"<td style='width:100px'>".$row['news_name']."</td>";
				...
				if($pageNow>1){
					$prePage = $pageNow-1;
					echo "<div class='page1'>"."<a href='adminindex.php?pageNow=$prePage'>pre</a> ";
					}
				if($pageNow<$pageCount){
					$nextPage = $pageNow+1;
					echo "<a href='adminindex.php?pageNow=$nextPage'>next</a> ";

 ...
 <body>
		...
		<h1>学生管理</h1>
			<?php 
				...
				$pageCount = 0;  //表示共有多少页
				$sql1 = "select count(id) from wd_stu";
				...
				$sql2 = "select * from wd_stu limit $pre,$pageSize";
				...
				//$res = mysql_query($sql,$con);
					...
					echo"<td style='width:100px'>"."学生id"."</td>";
					echo"<td style='width:100px'>"."学号"."</td>";
					echo"<td style='width:100px'>"."学生姓名"."</td>";
					echo"<td style='width:100px'>"."学生密码"."</td>";
				...
				while($row=mysqli_fetch_assoc($res2)){
					...
					echo "<tr style='width:600px'>";
					echo"<td style='width:100px'>".$row['stu_id']."</td>";
					echo"<td style='width:100px'>".$row['stu_num']."</td>";
					echo"<td style='width:100px'>".$row['stu_name']."</td>";
					echo"<td style='width:100px'>".$row['stu_pw']."</td>";
